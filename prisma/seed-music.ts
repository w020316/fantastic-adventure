...
async function main() {
  ...
  const tracksData = [
    // ===== 周杰伦（真实歌曲） =====
    { title: '晴天', artist: '周杰伦', category: 'pop', region: 'cn', duration: 269, url: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/99/4e/e2/994ee285-7c0d-73ab-85b7-8d3899a17242/mzaf_12441330510018253101.plus.aac.p.m4a', cover: 'https://is1-ssl.mzstatic.com/image/thumb/Music115/v4/29/c1/2d/29c12de6-54b4-f549-9d9f-07d8a04221ea/JAY.jpg/100x100bb.jpg', source: 'local', mood: 'passionate,sad', isHot: true, order: 1, playable: true, album: '七里香' },
